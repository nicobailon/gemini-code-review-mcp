...
class TestConfigurationDataModels(unittest.TestCase):
    ...
    def test_claude_memory_file_model_creation(self):
        ...
        self.assertEqual(memory_file.resolved_content, "# Project Memory\nUse TypeScript.")
    ...
    def test_configuration_context_model_creation(self):
        ...
        from configuration_context import ConfigurationContext, ClaudeMemoryFile, CursorRule
...
class TestPrecedenceLogic(unittest.TestCase):
    ...
    def test_claude_memory_precedence_hierarchy(self):
        ...
        from configuration_context import sort_claude_memory_by_precedence, ClaudeMemoryFile
    ...
    def test_cursor_rules_numerical_precedence(self):
        ...
        from configuration_context import sort_cursor_rules_by_precedence, CursorRule
...
class TestContentMerging(unittest.TestCase):
    ...
    def test_merge_claude_memory_content(self):
        ...
        from configuration_context import merge_claude_memory_content, ClaudeMemoryFile
    ...
    def test_merge_cursor_rules_content(self):
        ...
        from configuration_context import merge_cursor_rules_content, CursorRule
...
class TestSimplifiedCursorRuleHandling(unittest.TestCase):
    ...
    def test_get_all_cursor_rules(self):
        ...
        from configuration_context import get_all_cursor_rules, CursorRule
        ...
        self.assertIn(manual_rule, all_rules_result)  # Now included in simplified approach
    ...
    def test_get_applicable_cursor_rules_for_files(self):
        ...
        from configuration_context import get_applicable_cursor_rules_for_files, CursorRule
        ...
        applicable_rules = get_applicable_cursor_rules_for_files(all_rules, changed_files)
        ...
        self.assertIn(general_rule, applicable_rules)  # Now included in simplified approach
...
class TestConfigurationContextMerger(unittest.TestCase):
    ...
    def test_create_configuration_context_from_discoveries(self):
        ...
        from configuration_context import create_configuration_context, ClaudeMemoryFile, CursorRule
    ...
    def test_configuration_context_with_file_matching(self):
        ...
        from configuration_context import create_configuration_context_for_files, CursorRule
        ...
        context = create_configuration_context_for_files([], cursor_rules, changed_files)
    ...
    def test_error_handling_in_context_creation(self):
        ...
        from configuration_context import create_configuration_context_with_error_handling, ClaudeMemoryFile, CursorRule
