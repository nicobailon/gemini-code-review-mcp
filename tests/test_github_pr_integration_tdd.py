...
class TestPRFileChanges:
    ...
    def test_get_pr_file_changes_success(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            # Check modified file
            modified_file = next(f for f in result['changed_files'] if f['status'] == 'modified')
            ...
            # Check added file
            added_file = next(f for f in result['changed_files'] if f['status'] == 'added')
    ...
    def test_get_pr_file_changes_includes_statistics(self):
        ...
        mock_files_data = [
            ...
            {"filename": "file2.py", "status": "added", "additions": 15, "deletions": 0, "changes": 15},
            {"filename": "file3.py", "status": "removed", "additions": 0, "deletions": 10, "changes": 10}
        ]
...
class TestErrorHandlingAndEdgeCases:
    ...
    def test_github_enterprise_url_handling(self):
        ...
        from github_pr_integration import parse_github_pr_url, fetch_pr_data
...
class TestIntegrationScenarios:
    ...
    def test_complete_pr_analysis_workflow(self):
        ...
        from github_pr_integration import parse_github_pr_url, fetch_pr_data, get_pr_file_changes
